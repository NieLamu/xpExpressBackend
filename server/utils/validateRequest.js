...
var respHandler = require('./resHandler.js');
...
module.exports = function(req, res, next) {
    ...
    if (token && key) {
        ...
        try {
            ...
            // condition fails.
            // console.log(reqUser,key);
            if (reqUser.mobile !== key) {
                // res, status, data, message, err
                ...
                req.reqUser = reqUser;      //attach user information
                // req.locals.reqUser = reqUser;
                // res.reqUser = reqUser;
